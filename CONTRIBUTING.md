...
The [issue tracker](https://github.com/edloidas/apophenia/issues) is the preferred channel for [bug reports](#bugs), [features requests](#features) and [submitting pull requests](#pull-requests), but please respect the following restrictions:
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/apophenia.git doa
   # Navigate to the newly cloned directory
   cd apophenia
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/edloidas/apophenia.git
   ```
